...
public class cleangui extends Application {
  // Anfang Attribute
  ...
  public void bSubtr_Action(Event evt) {
    // TODO hier Quelltext einfügen
    output.appendText("-");
  } // end of bSubtr_Action

  public void bTimes_Action(Event evt) {
    // TODO hier Quelltext einfügen
    output.appendText("*");
  } // end of bTimes_Action
  ...
  public void bEnter1_Action(Event evt) {
    // TODO hier Quelltext einfügen
    output.appendText("");
  } // end of bEnter1_Action

  public void bClear_Action(Event evt) {
    // TODO hier Quelltext einfügen
    output.clear();
  } // end of bClear_Action
